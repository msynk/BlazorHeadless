...
/// parent <see cref="HDialog"/> so the JS interop can lock focus to it.
/// </para>
/// </summary>
public class HDialogPanel : HeadlessComponentBase
{
    [CascadingParameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
        ...
        builder.AddAttribute(10, "id", DialogContext?.PanelId ?? ComponentId);
    ...
    protected override Dictionary<string, object> BuildComponentAttributes()
    {
        ...
        attrs["aria-labelledby"] = DialogContext?.TitleId ?? string.Empty;
        attrs["aria-describedby"] = DialogContext?.DescriptionId ?? string.Empty;
        ...
        SetDataState(attrs, DialogContext?.IsOpen ?? false);
    ...
    {
        if (args.Key == "Escape" && DialogContext is not null)
