...
///   <item><b>Initial focus</b> — first focusable element in the panel by default; override via <see cref="HDialogPanel.InitialFocus"/>.</item>
...
/// </list>
///
/// <para><b>Requires <c>builder.Services.AddHeadlessUI()</c> at startup.</b></para>
///
/// <para><b>Usage:</b></para>
/// <code>
...
///         &lt;HDialogTitle&gt;Confirm action&lt;/HDialogTitle&gt;
///         &lt;HDialogDescription&gt;This cannot be undone.&lt;/HDialogDescription&gt;
...
/// </code>
/// </summary>
public class HDialog : HeadlessComponentBase
{
    ...
    /// <summary>
    /// Child content. Should contain an <see cref="HDialogPanel"/> and optionally an
    /// <see cref="HDialogBackdrop"/>, <see cref="HDialogTitle"/>, and
    /// <see cref="HDialogDescription"/>.
    /// </summary>
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
        ...
        {
            closeOuter.OpenComponent<CascadingValue<DialogContext>>(0);
    ...
    private DialogContext CreateContext() => new(
        isOpen: Open,
        baseId: ComponentId,
