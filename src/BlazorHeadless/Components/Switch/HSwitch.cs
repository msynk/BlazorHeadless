...
///     <see cref="HeadlessComponentBase.As"/> to render as <c>&lt;div&gt;</c>,
...
///     <see cref="SwitchRenderContext"/> for state-driven rendering of
///     thumb/track/icons.
///   </item>
///   <item>
...
/// </code>
/// </summary>
public class HSwitch : HeadlessComponentBase
{
    ...
    /// <summary>
    /// Content template receiving <see cref="SwitchRenderContext"/> for state-driven rendering.
    /// Plain content (without referencing context) works equally well.
    /// </summary>
    [Parameter]
    public RenderFragment<SwitchRenderContext>? ChildContent { get; set; }
    ...
    private SwitchRenderContext RenderContext => new()
    {
        IsChecked = IsChecked,
        Disabled = Disabled,
    };
