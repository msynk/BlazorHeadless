...
/// <summary>
/// Exposes the current state of an <see cref="BhButton"/> to its render
...
///
/// Passed via <c>RenderFragment&lt;BhButtonContext&gt;</c> — consumers can
/// access it through the implicit <c>@context</c> variable or a named
/// <c>Context="btn"</c> parameter.
/// </summary>
public sealed record BhButtonContext
{
