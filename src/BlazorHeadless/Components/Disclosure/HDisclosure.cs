...
/// The simpler sibling of <see cref="HAccordion"/>: one trigger, one panel.
///
...
///   </item>
///   <item>
///     <b>Compound API</b> — <see cref="HDisclosureButton"/> toggles,
///     <see cref="HDisclosurePanel"/> shows/hides. Cascading context wires
///     <c>aria-expanded</c>, <c>aria-controls</c>, and <c>aria-labelledby</c>.
///   </item>
///   <item>
///     <b>Render-prop context</b> — <see cref="ChildContent"/> is a
///     <see cref="RenderFragment{TValue}"/> of <see cref="DisclosureRenderContext"/>,
...
/// <code>
/// &lt;HDisclosure&gt;
///     &lt;HDisclosureButton&gt;Show details&lt;/HDisclosureButton&gt;
///     &lt;HDisclosurePanel&gt;Hidden content&lt;/HDisclosurePanel&gt;
/// &lt;/HDisclosure&gt;
/// </code>
///
...
/// <code>
/// &lt;HDisclosure&gt;
///     &lt;HDisclosureButton Context="d"&gt;@(d.IsOpen ? "Hide" : "Show")&lt;/HDisclosureButton&gt;
///     &lt;HDisclosurePanel Context="d"&gt;
///         Content here.
...
/// </code>
/// </summary>
public class HDisclosure : HeadlessComponentBase
{
    ...
    /// <summary>
    /// Child content. Should contain an <see cref="HDisclosureButton"/> and an
    /// <see cref="HDisclosurePanel"/>. The button and panel each expose a
    /// <see cref="DisclosureRenderContext"/> via <c>Context="d"</c> for state-driven UI.
    /// </summary>
    [Parameter]
    ...
    private DisclosureContext CreateContext() => new()
    {
        IsOpen = IsOpen,
        Disabled = Disabled,
