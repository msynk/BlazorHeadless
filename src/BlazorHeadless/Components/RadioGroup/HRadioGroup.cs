...
///   <item><b>Data attributes</b> — emits <c>data-orientation</c>, <c>data-disabled</c>; each <see cref="HRadio"/> emits <c>data-state="checked"|"unchecked"</c>.</item>
/// </list>
///
/// <para><b>Usage:</b></para>
/// <code>
/// &lt;HRadioGroup DefaultValue="medium" class="radio-group"&gt;
///     &lt;HRadio Value="small"  class="radio"&gt;Small&lt;/HRadio&gt;
///     &lt;HRadio Value="medium" class="radio"&gt;Medium&lt;/HRadio&gt;
///     &lt;HRadio Value="large"  class="radio"&gt;Large&lt;/HRadio&gt;
/// &lt;/HRadioGroup&gt;
/// </code>
/// </summary>
public class HRadioGroup : HeadlessComponentBase
{
    private readonly List<HRadio> _radios = new();
    ...
    /// <summary>Whether the entire group is disabled. Individual <see cref="HRadio"/> components can also be disabled independently.</summary>
    [Parameter]
    ...
    /// <summary>Child content. Should contain one or more <see cref="HRadio"/> components.</summary>
    [Parameter]
    ...
    private RadioGroupOrientation Orientation =>
        Vertical ? RadioGroupOrientation.Vertical : RadioGroupOrientation.Horizontal;
    ...
    {
        builder.OpenComponent<CascadingValue<RadioGroupContext>>(0);
    ...
    internal int RegisterRadio(HRadio radio)
    {
    ...
    internal void UnregisterRadio(HRadio radio)
    {
    ...
    private RadioGroupContext CreateContext() => new(
