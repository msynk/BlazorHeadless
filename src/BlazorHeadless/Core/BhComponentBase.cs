...
/// </code>
/// </summary>
public abstract class BhComponentBase : ComponentBase
{
    ...
    /// </summary>
    /// <remarks>
    /// Do NOT call <see cref="BhAttributeUtilities.Merge"/> here — that is done
    ...
    protected Dictionary<string, object> GetFinalAttributes()
        => BhAttributeUtilities.Merge(BuildComponentAttributes(), AdditionalAttributes);
    ...
    protected Dictionary<string, object> MergeAttributes(Dictionary<string, object> internalAttributes)
        => BhAttributeUtilities.Merge(internalAttributes, AdditionalAttributes);
    ...
    protected static void SetDataFlag(
        ...
        string name,
        bool condition)
        => BhAttributeUtilities.SetDataAttribute(attrs, name, condition);
    ...
    protected static void SetDataValue(
        ...
        string name,
        string value)
        => BhAttributeUtilities.SetDataAttribute(attrs, name, value);
